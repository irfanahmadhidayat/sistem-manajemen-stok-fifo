                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-tanggal_masuk">
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single" name="nama_barang" id="nama_barang"
                                    style="width: 100%">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append" style="width: 20%;">
                                        <input type="text" class="form-control" name="satuan" id="satuan_id"
                                            disabled>
                                    </div>
                                    <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-jumlah_masuk">
                                    </div>
                                </div>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (tanggalMasuk.showPicker) {
            tanggalMasuk.addEventListener('focus', function() {
                this.showPicker();
            });
        }
