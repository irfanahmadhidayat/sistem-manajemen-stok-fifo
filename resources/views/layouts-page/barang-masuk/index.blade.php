...
@include('layouts-page.barang-masuk.create')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_barangMasuk"><i
                                            class="fa fa-plus"></i>
                                        Barang Masuk</a>
                                </div>
...
@section('script')
    ...
    <script>
        function generateKodeTransaksi() {
            ...
            var kodeTransaksi = 'MSK-' + tanggalFormatted + '-' + nomorRandom;
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td>
                        <a href="javascript:void(0)" id="button_hapus_barangMasuk" data-id="${value.id}" class="btn btn-icon btn-danger btn-md mb-2"><i class="fas fa-trash"></i> </a>
                    </td>
                </tr>
            `;
                ...
                error: function(error) {
                    ...
                    if (error.responseJSON && error.responseJSON.tanggal_masuk && error.responseJSON
                        ...
                        $('#alert-tanggal_masuk').removeClass('d-none').addClass('d-block')
                            .html(error.responseJSON.tanggal_masuk[0]);
                    }
                    ...
                    if (error.responseJSON && error.responseJSON.jumlah_masuk && error.responseJSON
                        ...
                        $('#alert-jumlah_masuk').removeClass('d-none').addClass('d-block')
                            .html(error.responseJSON.jumlah_masuk[0]);
                    }
                }
            });
        });
