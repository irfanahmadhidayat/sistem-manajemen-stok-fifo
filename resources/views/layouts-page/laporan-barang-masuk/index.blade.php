    ...
    <div class="content-wrapper">
        ...
        <div class="content mx-3">
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-right">
                                    <a href="{{ route('laporan.barang-masuk.print', ['nama_barang' => $namaBarangDipilih]) }}"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3 class="card-title">
                                        Barang Masuk {{ $namaBarangDipilih ? '- ' . $namaBarangDipilih : '(Semua Barang)' }}
                                    </h3>
                                </div>
                ...
                @else
                    <div class="alert alert-info">Tidak ada data barang masuk.</div>
                @endif
            </div>
        </div>
    </div>
